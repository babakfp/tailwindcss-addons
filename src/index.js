...
export default (userConfig = {}) => {
    ...
    return {
        presets: [
            ...
            config.presets.fontWeightRegular && import("./presets/fontWeightRegular.js"),
            config.presets.moreDefaultValues && import("./presets/moreDefaultValues.js"),
            config.presets.screenSizeFix && import("./presets/screenSizeFix.js"),
        ],
        plugins: [
            ...
            config.utilities.inputResets && import("./utilities/inputResets.js"),
            config.utilities.insetCenter && import("./utilities/insetCenter.js"),
            config.utilities.overflowUnset && import("./utilities/overflowUnset.js"),
            config.utilities.tapHighlight && import("./utilities/tapHighlight.js"),
