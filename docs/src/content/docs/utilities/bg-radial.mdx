...
<Preview useGrid={false}>
    <div class={`${examples.gap} ${examples._base_} ${examples.basic}`} />
</Preview>

<Code
    code={`<div class="${examples.gap} ${examples._base_} ${examples.basic}"></div>`}
    lang="jsx"
    mark={[examples.gap]}
/>
...
<Preview useGrid={false}>
    <div class={`${examples.gapX} ${examples._base_} ${examples.basic}`} />
</Preview>

<Code
    code={`<div class="${examples.gapX} ${examples._base_} ${examples.basic}"></div>`}
    lang="jsx"
    mark={[examples.gapX]}
/>
...
<Preview useGrid={false}>
    <div class={`${examples.gapY} ${examples._base_} ${examples.basic}`} />
</Preview>

<Code
    code={`<div class="${examples.gapY} ${examples._base_} ${examples.basic}"></div>`}
    lang="jsx"
    mark={[examples.gapY]}
/>
