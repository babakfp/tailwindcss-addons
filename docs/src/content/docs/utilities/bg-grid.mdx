...
<Preview useGrid={false}>
    <div class={`${examples.size} ${examples._base_} ${examples.basic}`} />
</Preview>

<Code
    code={`<div class="${examples.size} ${examples._base_} ${examples.basic}"></div>`}
    lang="jsx"
    mark={[examples.size]}
/>
...
<Preview useGrid={false}>
    <div class={`${examples.width} ${examples._base_} ${examples.basic}`} />
</Preview>

<Code
    code={`<div class="${examples.width} ${examples._base_} ${examples.basic}"></div>`}
    lang="jsx"
    mark={[examples.width]}
/>
...
<Preview useGrid={false}>
    <div class={`${examples.height} ${examples._base_} ${examples.basic}`} />
</Preview>

<Code
    code={`<div class="${examples.height} ${examples._base_} ${examples.basic}"></div>`}
    lang="jsx"
...
<Preview useGrid={false}>
    <div
        class={`${examples.borderWidth} ${examples._base_} ${examples.basic}`}
    />
</Preview>

<Code
    code={`<div class="${examples.borderWidth} ${examples._base_} ${examples.basic}"></div>`}
    lang="jsx"
